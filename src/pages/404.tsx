import notFoundImage from "$assets/Illustrations/others/visuals-JpTY4gUviJM-unsplash.jpg";
    ...
    <section className="bg-white dark:bg-gray-900 ">
      <div className="container mx-auto min-h-screen px-6 py-12 lg:flex lg:items-center lg:gap-12">
        ...
        <div className="relative mt-8 w-full lg:mt-0 lg:w-1/2">
          <Image src={notFoundImage} alt="404" className="  h-full w-full  rounded-lg object-cover  md:h-96 " />
        </div>
      </div>
    </section>
  );
