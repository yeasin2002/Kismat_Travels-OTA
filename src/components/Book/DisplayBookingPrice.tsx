...
import { DetailedHTMLProps, Dispatch, FC, Fragment, HTMLAttributes, SetStateAction, useEffect } from "react";
...
export const DisplayBookingPrice: FC<DisplayBookingPriceProps> = ({ isDataLoading, setIsDataLoading, ...rest }) => {
