...
const Aside = ({ state }: { state: Boolean }) => {
  return (
    <div className="relative h-full w-full ">
      <div className="flex w-full flex-col items-center justify-center border-b-2 border-gray-300 pb-5">
      ...
      <div className="relative w-full">
        ...
        {Routes.map((route, index) => {
          return (
            <Button title={route.label} key={index} variant="outline" className="w-full justify-start" asChild>
